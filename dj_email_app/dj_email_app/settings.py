"""
Django settings for dj_email_app project.
...
SECRET_KEY = '8%*lnzxk1j3q*-s3j23*(fyrhhyr7zx_+typh8lor2hih89nl8'
...
ROOT_URLCONF = 'dj_email_app.urls'
...
WSGI_APPLICATION = 'dj_email_app.wsgi.application'
